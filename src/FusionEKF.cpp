...
FusionEKF::FusionEKF() {
  /**
   * Initializes the FusionEKF.
   * Sets the process and measurement noises
   */

  // not initialised yet
  is_initialized_ = false;

  // set previous timstap to zero
  previous_timestamp_ = 0;

  // initializing empty process matrix (radar)
  Hj_ = MatrixXd(3, 4);
